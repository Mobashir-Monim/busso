<script>
    const setConfirmationMessage = log => {
        confirmationMessage.innerHTML = `
            <p>You are about to revert the changes of a <b><span class="text-danger">User::delete</span></b> with email address <b><span class="text-danger">${ log['change_data']['user']['updated']['email'] }</span></b>.</p>
