<script>
    const setConfirmationMessage = log => {
        confirmationMessage.innerHTML = `
            <p>You are about to revert the changes of a <b><span class="text-danger">RoleUser::detach</span></b> with role name <b><span class="text-danger">${ log['change_data']['role']['name'] }</span></b>.</p>
